...
2.  **Assumption Handling:** If the user request lacks certain parameters, make sensible baseline assumptions:
    *   *Default Stock Price / Strike:* $100 (or $130/$140 if context implies)
    *   *Default Volatility:* 30% (0.30)
    *   *Default Maturity:* 6 months (0.5 years)
    *   *Default Risk-Free Rate:* 4% (0.04)
    *   State these assumptions clearly in the output so the user is informed.
