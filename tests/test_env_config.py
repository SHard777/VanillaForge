...
def test_environment_configuration():
    ...
    if vertex_flag == "true":
        # Option 2: Vertex AI
        assert os.environ.get("GOOGLE_CLOUD_PROJECT"), "GOOGLE_CLOUD_PROJECT must be set when using Vertex AI"
        assert os.environ.get("GOOGLE_CLOUD_LOCATION"), "GOOGLE_CLOUD_LOCATION must be set when using Vertex AI"
    else:
        # Option 1: AI Studio
