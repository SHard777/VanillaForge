...
def test_pricing_skill_bsm_dividend():
    ...
    result_no_div = black_scholes_pricing(S=100.0, K=100.0, T=1.0, r=0.05, sigma=0.2, option_type="call")
    result_div = black_scholes_pricing(S=100.0, K=100.0, T=1.0, r=0.05, sigma=0.2, option_type="call", q=0.03)
...
def test_pricing_skill_numpy_array():
    ...
    result = black_scholes_pricing(S=S_array, K=K_array, T=T_array, r=0.05, sigma=0.2, option_type="call")
